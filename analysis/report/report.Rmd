...
with $\hat{\boldsymbol{\Sigma}}$ estimated without
constraints.
...
vector $\hat{\boldsymbol{\beta}}$ contains the four estimated
cell means:
...
\mathbf{L}'\hat{\boldsymbol{\beta}}, \qquad
...
equations when $\hat{\boldsymbol{\Sigma}}$ is unrestricted:
